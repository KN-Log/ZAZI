                ...
                <Col lg="9">
                    <Card className="mt-3">
                        <CardBody>
                            ...
                            <CardText className={textStyle}>
                                – сопротивление нулевого защитного провода; <Majax.Node inline formula="jX_{п}" />– индуктивное сопротивление петли "фаза-нуль".
                            </CardText>
                            <CardText className={textStyle}>
                            ...
                            <CardText>
                                где <Majax.Node inline formula="P_{Г}" />– габаритная мощность силового трансформатора, <Majax.Node inline formula="кВАЭ"/>; <Majax.Node inline formula="AиB"/>–коэффициенты, имеющие следующие значения:
                            </CardText>
                            <CardText>
                            ...
                            <CardText>
                                а) <Majax.Node inline formula="*" /> – проводник круглого сечения, <Majax.Node inline formula="**" /> – проводник прямоугольного сечения толщиной <Majax.Node inline formula="4 мм" />;
                            </CardText>
                            <CardText>
                            ...
                            <CardText>
                                С учётом изложенного составляем алгоритм оценки отключающей способности зануления:
                            </CardText>
                            <CardText>
