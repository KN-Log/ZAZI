                        ...
                        <CardBody >
                            ...
                            <CardText className={textStyle}>
                                <br />
                                    ...
                                    Устройства по рис. <Majax.Node inline formula="5.3" /> и <Majax.Node inline formula="5.4" /> выполняются как контурные, так и выносные, по рис. <Majax.Node inline formula="5.5" /> выполняют как выносное заземление
                            </CardText>
                            <CardText>
                                <br />
                                    ...
                                    соединенных с отдельным защитным заземлением. Ток молнии содержит значительную высоко-частотную составляющую (с частотой более <Majax.Node inline formula="100 кГц" />),
                                    ...
                                    от <Majax.Node inline formula="10" /> до <Majax.Node inline formula="40"/> <Majax.Node inline formula="Ом" />. Для защиты от наведенных зарядов используется защитное
                                    заземление <Majax.Node inline formula="(рис.5.3)" />, причем <Majax.Node inline formula="R_{з}≤10"/> <Majax.Node inline formula="Ом" />,
                            </CardText>
                            <CardText className={textStyle}>
                                <br />
                                    ...
                                    напряжением <Majax.Node inline formula="U_{л}=" /> <Majax.Node inline formula="1000" /> В норма сопротивления заземления  <Majax.Node inline formula="R_{з}=4"/> <Majax.Node inline formula="Ом"/>при габаритной
                            ...
                            <CardText>
                                <br />
                                    В сетях с заземленной нейтралью (системы  <Majax.Node inline formula="TN-C" /> или  <Majax.Node inline formula="TN-S" /> ) при <Majax.Node inline formula="U_{л}=1000 В" /> ( <Majax.Node inline formula="рис.5.4" />),
                            ...
                            <CardText className={textStyle}>
                                <br />
                                    ...
                                    соответственно при указанных выше значениях <Majax.Node inline formula="U_{л}" />. Приудельном сопротивлении земли <Majax.Node inline formula="p > 100О м·м" /> допускается увеличитьуказанные нормы в
                                    <Majax.Node inline formula="\frac{p}{100} ≤ 10" />. раз Величину сопротивления <Majax.Node inline formula="R_{р}" /> рабочего заземления обычно устанав-ливают
                                    в пределах <Majax.Node inline formula="Rр ≤ 0.05 R_{эу}" />. Естественными заземлителями обычно являются размещенные вземле железобетонные конструкции фундамента здания.
                                    ...
                                    Такой учет достигается увеличением в <Majax.Node inline formula="1.8" /> раза удельного сопротивления грунта, в котором расположен естественный заземлитель.
                                    Сопротивление заземления <Majax.Node inline formula="R^{′}_{В}" />, вертикального электрода
                            </CardText>
                            <CardText className="text-center">
                            ...
                            <CardText className={textStyle}>
                                <br />
                                    ...
                                    Сопротивление <Majax.Node inline formula="R_{Г}" /> заземления горизонтального электрода (есте-ственного),
                            ...
                            <CardText>
                                <br />
                                    здесь
                                    <Majax.Node inline formula="ρ_{Г}" />– удельное сопротивление земли для горизонтального элек-трода,
                            ...
                            <CardText>
                                <br />
                                    ...
                                    <Majax.Node inline formula="R_{Г}" /> растеканию тока в земле одиночного горизонтального электрода длиной
                                    <Majax.Node inline formula="L_{1}" /> и эквивалентным диаметром <Majax.Node inline formula="d_{1}" />:
                            </CardText>
                            <CardText className="text-center">
                            ...
                            <CardText className={textStyle}>
                                здесь <Majax.Node inline formula="η_{В}, η_{Г}" /> – коэффициенты использования соответственно горизонтального и вертикального электродов.
                                Величины коэффициентов использования в справочнике <Majax.Node inline formula="[1]" /> даютсяв табличном виде с допущением линейной интерполяции для промежуточных значений <Majax.Node inline formula="L,L_{1},N" />. При разработке файла, обеспечивающегоисследование заземляющего устройства,
                                предпочтительнее аналитиче-ский эквивалент для <Majax.Node inline formula="η_{В}, η_{Г}" /> (при размещении заземлителей по контуру)
                            </CardText>
                            <CardText className="text-center">
                            ...
                            <CardText className="text-center">
                                ...
                                от источника тока <Majax.Node inline formula="E" />.
                            </CardText>
                            <CardText className={textStyle}>
                                Коррозия металла заземлителя зависит от тока, проходящегоче-рез электроды.
                                Сечение металла искусственных заземлителей, требующееся для обеспечения нормативного срока службы <Majax.Node inline formula="T_{c}" /> заземления,оцениваете соотношением:
                            </CardText>
                            <CardText className="text-center">
                                <Majax.Node inline formula="S=\frac{13.5IR_{B}}{LN(R_{В}+R_{Г})}" />,   <Majax.Node inline formula="S_{1}=\frac{13.5IR_{Г}}{L_{1}(N-1)(R_{В}+R_{Г})}" />
                            </CardText>
                            <CardText className={textStyle}>
                                здесь <Majax.Node inline formula="I" /> – среднее за время <Majax.Node inline formula="T_{c}" /> значение амплитуды тока (<Majax.Node inline formula="А" />) заземления, <Majax.Node inline formula="T_{c}=15" /> лет; <Majax.Node inline formula="S,S_{1}" /> – сечение металла соответственно вертикального игоризонтальной электродов, <Majax.Node inline formula="см^{2}" />.
                            </CardText>
                        </CardBody>
                    </Card>
                </Col>
